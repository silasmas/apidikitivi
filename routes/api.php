...
Route::group(['middleware' => ['api', 'auth:sanctum', 'localization']], function () {
    ...
    Route::post('media/upload_files_again/{id}', 'App\Http\Controllers\API\MediaController@uploadFiles')->name('media.api.upload_files');
    ...
    // User
    Route::get('user', 'App\Http\Controllers\API\UserController@userOnline')->name('user.api.userOnline');
